...
def SEIRV_model_homogeneous(t, y, df):
    ...
    S, E, I, R, PD, Sv, Ev, Iv, Rv, PDv, C, Cv = y
    
    # Total population
    N = S + E + I + R + PD + Sv + Ev + Iv + Rv + PDv

    if t==0:
        behaviour, ucases_memory, udeaths_memory, cases_memory, deaths_memory = update_vaccine_uptake_rate(t, td, ucases_memory, udeaths_memory, cases_memory, deaths_memory, m, behaviour_function, r, alpha, S, E, I, R, PD, Sv, Ev, Iv, Rv, PDv, N, C, Cv)
        if (S+E+R) < 10:
            v = 0
        elif S < 10:
            v = 0
    ...
    if (S < 10) or ((S + E + R) < 10) or (r+alpha == 0):
        ...
        dSdt = -foi(beta, vaccine_efficacy, S, E, I, R, PD, Sv, Ev, Iv, Rv, PDv, N)*S
        dEdt = foi(beta, vaccine_efficacy, S, E, I, R, PD, Sv, Ev, Iv, Rv, PDv, N)*S - sigma*E
        dIdt = sigma*E - gamma*I
        dRdt = (1-d)*gamma*I
        dPDdt = d*gamma*I
        # Equation for cumulative infectious
        dCdt = sigma*E
        # dCdt = foi(beta, vaccine_efficacy, S, E, I, R, PD, Sv, Ev, Iv, Rv, PDv, N)*S

        # Equations for the vaccinated population
        dSvdt = -(1-vaccine_efficacy)*foi(beta, vaccine_efficacy, S, E, I, R, PD, Sv, Ev, Iv, Rv, PDv, N)*Sv
        dEvdt = (1-vaccine_efficacy)*foi(beta, vaccine_efficacy, S, E, I, R, PD, Sv, Ev, Iv, Rv, PDv, N)*Sv - sigma*Ev
        dIvdt = sigma*Ev - gamma*Iv
        dRvdt = (1-(1-vaccine_efficacy)*d)*gamma*Iv
        dPDvdt = (1-vaccine_efficacy)*d*gamma*Iv
        # Equation for cumulative infectious
        dCvdt = sigma*Ev
        # dCvdt = (1-vaccine_efficacy)*foi(beta, vaccine_efficacy, S, E, I, R, PD, Sv, Ev, Iv, Rv, PDv, N)*Sv
    else:
         # Equations for the unvaccinated population
        dSdt = -foi(beta, vaccine_efficacy, S, E, I, R, PD, Sv, Ev, Iv, Rv, PDv, N)*S - v*S
        dEdt = foi(beta, vaccine_efficacy, S, E, I, R, PD, Sv, Ev, Iv, Rv, PDv, N)*S - sigma*E - v*E
        dIdt = sigma*E - gamma*I
        ...
        # Equations for the vaccinated population
        dSvdt = -(1-vaccine_efficacy)*foi(beta, vaccine_efficacy, S, E, I, R, PD, Sv, Ev, Iv, Rv, PDv, N)*Sv + v*S
        dEvdt = (1-vaccine_efficacy)*foi(beta, vaccine_efficacy, S, E, I, R, PD, Sv, Ev, Iv, Rv, PDv, N)*Sv - sigma*Ev + v*E
        dIvdt = sigma*Ev - gamma*Iv
    ...
    return [dSdt, dEdt, dIdt, dRdt, dPDdt, dSvdt, dEvdt, dIvdt, dRvdt, dPDvdt, dCdt, dCvdt]
...
def update_vaccine_uptake_rate(t, td, ucases_memory, udeaths_memory, cases_memory, deaths_memory, m, behaviour_function, r, alpha, S, E, I, R, PD, Sv, Ev, Iv, Rv, PDv, N, C, Cv):   
    # Total population
    N = S + E + I + R + PD + Sv + Ev + Iv + Rv + PDv
...
def foi(beta, vaccine_efficacy, S, E, I, R, PD, Sv, Ev, Iv, Rv, PDv, N):
    FOI = beta*(I+Iv)/alive(S, E, I, R, PD, Sv, Ev, Iv, Rv, PDv)
    return FOI
